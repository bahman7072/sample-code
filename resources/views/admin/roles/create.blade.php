                        ...
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="عنوان مقام را وارد کنید">
                                    @error('name')
                            ...
                            <div class="col-lg-8 offset-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="label" class="form-control @error('label') is-invalid @enderror" id="label" placeholder="توضیح مقام را وارد کنید">
                                     @error('label')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
