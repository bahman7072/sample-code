...
class PermissionController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('can:create-permissions')->only(array('create', 'store'));
        $this->middleware('can:edit-permissions')->only(array('edit', 'update'));
    ...
    public function store(Request $request)
    {
        ...
        alert()->success('دسترسی با موفقیت ایجاد شد')->autoclose(4000);
    ...
    public function destroy(Permission $permission)
    {
        ...
        alert()->success('دسترسی "'. $permission->label .'" با موفقیت حذف شد')->autoclose(4000);
        return back();
    }
}
